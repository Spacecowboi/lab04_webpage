...
alert("Hey there, long time no see... " + name);


let purpose = prompt("What are you doing here?");
alert("Hmm, if you say so" + " " + name + ", Do you really think " + purpose + " is a really good use of your time?");
...
if (question) {
  alert("Fine, as long as you don't get in my way")
} else {
  alert("Then leave. I didn't want you here to begin with")
}
